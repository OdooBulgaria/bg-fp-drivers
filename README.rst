...
Драйвери за управления на фискалну устройства на Python. Клонинкг на pyshtrih с добавена поддръжка на Български ФУ.

Съдържание
----------
* `Инсталация от изходен код`_
* `Инсталация от изходен код`_
* `Начин на използване`_
* `Поддържани команди`_
* `Лиценз`_
...
::
    ...
    $ git clone https://github.com/rosenvladimirov/bg-fp-drivers.git
...
.. code-block:: python
    ...
    if __name__ == '__main__':
        ...
        if not devices:
            raise Exception(u'Устройството не е открито')
...
Поддържани команди
------------------
**Внимание!** Съответните команди са обвързани с конкретните ФУ.
...
Лиценз
------
MIT лиценз. Подробности във файла `LICENSE <https://github.com/oleg-golovanov/pyshtrih/blob/master/LICENSE>`_.
